...
(35, 7, '2023-12-23 07:14:16', 3100000, NULL, 0);
...
-- 
ALTER TABLE `favor`
  ADD CONSTRAINT `f6` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `f7` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `cart`
--
ALTER TABLE `cart`
  ADD CONSTRAINT `f8` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `f9` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);
