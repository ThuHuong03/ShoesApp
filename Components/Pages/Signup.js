...
export default function Signup({ navigation }) {
  ...
  const toggleVisibility = () => {
    ...
    if (Email == "") {
      ...
      Alert.alert("Notice", "Please enter your Email Correctly!");
      return;
    } else if (Password == "") {
      ...
      Alert.alert(
        "Notice",
        "Please enter your Confirm Password matches the Password"
      );
      return;
  ...
  const SignUp = () => {
    ...
    if (UserName == "" || Phone == "" || Address == "") {
      ...
      Alert.alert("Notice", "Please fill your Phone correctly");
      return;
    } else {
      // Auth.Signin();

      axios
        .post(`${Localhost}register.php`, {
          email: Email,
          password: Password,
          name: UserName,
          phone: Phone,
